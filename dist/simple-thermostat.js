...
`;function ft(t,e,i,n={}){i=null==i?{}:i;const o=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return o.detail=i,t.dispatchEvent(o),o}!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var n=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css","top"===i&&n.firstChild?n.insertBefore(o,n.firstChild):n.appendChild(o),o.styleSheet?o.styleSheet.cssText=t:o.appendChild(document.createTextNode(t))}}(mt);const gt="dual";const vt={getSetpoints:t=>function(t){return"number"==typeof t.target_temp_high&&"number"==typeof t.target_temp_low?gt:"single"}(t)===gt?{target_temp_low:t.target_temp_low,target_temp_high:t.target_temp_high}:{temperature:t.temperature},getRange:t=>({min:t?.min_temp??null,max:t?.max_temp??null,step:t?.target_temp_step??null}),getCurrentValue:t=>t?.current_temperature??null,getCurrentValueTemplate:()=>"{{current_temperature|formatNumber}}",getSetpointService:()=>({domain:"climate",service:"set_temperature"}),getModeService:t=>"vane_horizontal"===t||"vane_vertical"===t?`climate.set_${t}`:`climate.set_${t}_mode`,getModePayloadKey:t=>"vane_horizontal"===t||"vane_vertical"===t?t:`${t}_mode`,getModeAttribute:t=>"vane_horizontal"===t||"vane_vertical"===t?`${t}_positions`:`${t}_modes`,getDefaultControl:()=>["hvac","preset"],getLocalizationDomain:()=>"climate"},_t={climate:vt,fan:{getSetpoints:t=>({percentage:t?.percentage}),getRange:t=>({min:0,max:100,step:1}),getCurrentValue:t=>t?.percentage??null,getCurrentValueTemplate:()=>"{{percentage|formatNumber}}",getSetpointService:()=>({domain:"fan",service:"set_percentage"}),getModeService:t=>"direction"===t?"fan.set_direction":"oscillating"===t?"fan.oscillate":`fan.set_${t}_mode`,getModePayloadKey:t=>"direction"===t?"direction":"oscillating"===t?"oscillating":`${t}_mode`,getModeAttribute:t=>"direction"===t?"direction":"oscillating"===t?"oscillating":`${t}_modes`,getDefaultControl:()=>["preset"],transformModePayloadValue:(t,e)=>"oscillating"===t?"true"===e:e,getLocalizationDomain:()=>"fan"},humidifier:{getSetpoints:t=>({humidity:t?.humidity}),getRange:t=>({min:t?.min_humidity??0,max:t?.max_humidity??100,step:1}),getCurrentValue:t=>t?.current_humidity??null,getCurrentValueTemplate:()=>"{{current_humidity|formatNumber}}",getSetpointService:()=>({domain:"humidifier",service:"set_humidity"}),getModeService:t=>"mode"===t?"humidifier.set_mode":`humidifier.set_${t}`,getModePayloadKey:t=>"mode"===t?"mode":t,getModeAttribute:t=>"mode"===t?"available_modes":`${t}_modes`,getDefaultControl:()=>["mode"],getLocalizationDomain:()=>"humidifier"}};function yt(t){if(!t)return vt;const e=t.split(".")[0];return _t[e]??vt}const bt=process.env.BUILD_TIME,$t=t=>structuredClone(t);const wt={entity:"Entity (required)",current_value_entity:"Current temperature entity (optional)",show_header:"Show header",name:"Name",icon:"Icon","toggle.entity":"Toggle entity","toggle.name":"Toggle label","toggle.icon":"Toggle icon",show_preset:"Preset mode",show_fan:"Fan mode",show_swing:"Swing mode",show_swing_horizontal:"Swing horizontal",show_swing_vertical:"Swing vertical","layout.mode.names":"Show mode names","layout.mode.icons":"Show mode icons","layout.mode.headings":"Show mode headings",decimals:"Decimals",unit:"Unit","layout.step":"Step layout",step_size:"Step size",fallback:"Fallback text",hide_setpoint:"Hide setpoint controls","hide.temperature":"Hide temperature","hide.state":"Hide state","label.temperature":"Temperature label","label.state":"State label","layout.sensors.type":"Sensor layout","layout.sensors.labels":"Show sensor labels",tap_action:"Tap action",hold_action:"Hold action",double_tap_action:"Double-tap action"};function xt(t,e,i){const n=e.split(".");let o=t;for(;n.length>1;){const t=n.shift();Object.hasOwn(o,t)||(o[t]={}),o=o[t]}o[n[0]]=i}function At(t,e){const i=e.split(".");let n=t;for(;i.length>1;){const t=i.shift();if(!n[t])return;n=n[t]}delete n[i[0]]}function St(t,e,i){const n=t.control;return!1!==n&&(Array.isArray(n)?n.includes(e):"object"==typeof n?e in n:i.getDefaultControl().includes(e))}class Et extends lt{constructor(){super(...arguments),this._valueChanged=t=>{const e=t.detail.value;ft(this,"config-changed",{config:this._applyFormChange(e)})},this._computeLabel=t=>wt[t.name]??t.name,this._stylesChanged=t=>{const e=t.detail?.value,i=$t(this.config);""===e||null==e?delete i.styles:i.styles=e,ft(this,"config-changed",{config:i})}}static get styles(){return mt}setConfig(t){this.config=t||{}}_openLink(){window.open("https://github.com/duczz/ha-simple-thermostat/blob/master/README.md","_blank","noopener")}_buildFormData(){const t=yt(this.config.entity),e=this.config.header&&"object"==typeof this.config.header?this.config.header:{};return{entity:this.config.entity??"",current_value_entity:this.config.current_value_entity??"",show_header:!1!==this.config.header,decimals:this.config.decimals??1,unit:this.config.unit??"","layout.step":this.config.layout?.step??"row",step_size:null!=this.config.step_size?String(this.config.step_size):"auto",fallback:this.config.fallback??"","hide.temperature":!0===this.config.hide?.temperature,"hide.state":!0===this.config.hide?.state,"label.temperature":this.config.label?.temperature??"","label.state":this.config.label?.state??"","layout.sensors.type":this.config.layout?.sensors?.type??"table","layout.sensors.labels":!1!==this.config.layout?.sensors?.labels,"layout.mode.names":!1!==this.config.layout?.mode?.names,"layout.mode.icons":!1!==this.config.layout?.mode?.icons,"layout.mode.headings":!0===this.config.layout?.mode?.headings,hide_setpoint:!0===this.config.hide_setpoint,show_preset:St(this.config,"preset",t),show_fan:St(this.config,"fan",t),show_swing:St(this.config,"swing",t),show_swing_horizontal:St(this.config,"swing_horizontal",t),show_swing_vertical:St(this.config,"swing_vertical",t),name:e.name??"",icon:"string"==typeof e.icon?e.icon:"","toggle.entity":e.toggle?.entity??"","toggle.name":e.toggle?.name??"","toggle.icon":"string"==typeof e.toggle?.icon?e.toggle.icon:"",tap_action:this.config.tap_action??{action:"more-info"},hold_action:this.config.hold_action??{action:"none"},double_tap_action:this.config.double_tap_action??{action:"none"}}}_applyFormChange(t){const e=$t(this.config),i=["entity","current_value_entity","hide_setpoint","decimals","unit","fallback","layout.step","layout.mode.names","layout.mode.icons","layout.mode.headings","layout.sensors.type","layout.sensors.labels","hide.temperature","hide.state","label.temperature","label.state","tap_action","hold_action","double_tap_action"];for(const n of i){const i=t[n];null==i||""===i?At(e,n):xt(e,n,i)}if(!1===t.show_header)e.header=!1;else{!1!==e.header&&null!=e.header||(e.header={});const i=t.name,n=t.icon,o=t["toggle.entity"],s=t["toggle.name"],r=t["toggle.icon"];i?e.header.name=i:delete e.header.name,n?e.header.icon=n:delete e.header.icon,o?(e.header.toggle=e.header.toggle||{},e.header.toggle.entity=o,s?e.header.toggle.name=s:delete e.header.toggle.name,r?e.header.toggle.icon=r:delete e.header.toggle.icon):delete e.header.toggle}if("auto"===t.step_size||""===t.step_size||null==t.step_size)delete e.step_size;else{const i=Number(t.step_size);e.step_size=Number.isNaN(i)?t.step_size:i}const n=yt(e.entity).getDefaultControl(),o=["hvac"];t.show_preset&&o.push("preset"),t.show_fan&&o.push("fan"),t.show_swing&&o.push("swing"),t.show_swing_horizontal&&o.push("swing_horizontal"),t.show_swing_vertical&&o.push("swing_vertical");const s=!1===t["layout.mode.names"],r=!1===t["layout.mode.icons"];return s&&r?e.control=!1:o.length===n.length&&o.every((t,e)=>t===n[e])?delete e.control:e.control=o,e}render(){if(!this.hass||!this.config)return B``;const t=function(t){const e=[];return!1!==t.header&&e.push({type:"grid",schema:[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{name:"toggle.entity",selector:{entity:{}}},{name:"toggle.name",selector:{text:{}}},...t.header?.toggle?.entity?[{name:"toggle.icon",selector:{icon:{}}}]:[]),[{name:"entity",required:!0,selector:{entity:{domain:["climate","fan","humidifier"]}}},{name:"current_value_entity",selector:{entity:{domain:["sensor","input_number"]}}},{type:"expandable",title:"Header",schema:[{name:"show_header",selector:{boolean:{}}},...e]},{type:"expandable",title:"Mode Controls",schema:[{type:"grid",column_min_width:"130px",schema:[{name:"show_preset",selector:{boolean:{}}},{name:"show_fan",selector:{boolean:{}}},{name:"show_swing",selector:{boolean:{}}},{name:"show_swing_horizontal",selector:{boolean:{}}},{name:"show_swing_vertical",selector:{boolean:{}}}]},{type:"grid",column_min_width:"130px",schema:[{name:"layout.mode.names",selector:{boolean:{}}},{name:"layout.mode.icons",selector:{boolean:{}}},{name:"layout.mode.headings",selector:{boolean:{}}}]}]},{type:"expandable",title:"Layout & Display",schema:[{type:"grid",schema:[{name:"decimals",selector:{number:{min:0,max:5,step:1,mode:"box"}}},{name:"unit",selector:{text:{}}}]},{type:"grid",schema:[{name:"layout.step",selector:{select:{mode:"dropdown",options:[{value:"row",label:"Row"},{value:"column",label:"Column"}]}}},{name:"step_size",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Auto (from entity)"},{value:"0.1",label:"0.1"},{value:"0.5",label:"0.5"},{value:"1",label:"1"}]}}}]},{name:"fallback",selector:{text:{}}},{name:"hide_setpoint",selector:{boolean:{}}},{type:"grid",column_min_width:"160px",schema:[{name:"hide.temperature",selector:{boolean:{}}},{name:"hide.state",selector:{boolean:{}}}]},{type:"grid",column_min_width:"160px",schema:[{name:"label.temperature",selector:{text:{}}},{name:"label.state",selector:{text:{}}}]},{type:"grid",column_min_width:"160px",schema:[{name:"layout.sensors.type",selector:{select:{mode:"dropdown",options:[{value:"table",label:"Table"},{value:"list",label:"List"}]}}},{name:"layout.sensors.labels",selector:{boolean:{}}}]}]},{type:"expandable",title:"Interactions",schema:[{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"none"}}},{name:"double_tap_action",selector:{ui_action:{default_action:"none"}}}]}]}(this.config),i=this._buildFormData();return B`
  ...
  `}var Rt,Ht={exports:{}};function It(){return Rt||(Rt=1,function(t){function e(t){var i,n,o=new Error(t);return i=o,n=e.prototype,Object.setPrototypeOf?Object.setPrototypeOf(i,n):i.__proto__=n,o}function i(t,i,n){var o=i.slice(0,n).split(/\n/),s=o.length,r=o[s-1].length+1;throw e(t+=" at line "+s+" col "+r+":\n\n  "+i.split(/\n/)[s-1]+"\n  "+Array(r).join(" ")+"^")}e.prototype=Object.create(Error.prototype,{name:{value:"Squirrelly Error",enumerable:!1}});var n=new Function("return this")().Promise,o=!1;try{o=new Function("return (async function(){}).constructor")()}catch(t){if(!(t instanceof SyntaxError))throw t}function s(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function r(t,e,i){for(var n in e)s(e,n)&&(null==e[n]||"object"!=typeof e[n]||"storage"!==n&&"prefixes"!==n||i?t[n]=e[n]:t[n]=r({},e[n]));return t}var a=/^async +/,l=/`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})*}|(?!\${)[^\\`])*`/g,c=/'(?:\\[\s\w"'\\`]|[^\n\r'\\])*?'/g,d=/"(?:\\[\s\w"'\\`]|[^\n\r"\\])*?"/g,h=/[.*+\-?^${}()|[\]\\]/g;function u(t){return h.test(t)?t.replace(h,"\\$&"):t}function p(t,n){n.rmWhitespace&&(t=t.replace(/[\r\n]+/g,"\n").replace(/^\s+|\s+$/gm,"")),l.lastIndex=0,c.lastIndex=0,d.lastIndex=0;var o=n.prefixes,s=[o.h,o.b,o.i,o.r,o.c,o.e].reduce(function(t,e){return t&&e?t+"|"+u(e):e?u(e):t},""),r=new RegExp("([|()]|=>)|('|\"|`|\\/\\*)|\\s*((\\/)?(-|_)?"+u(n.tags[1])+")","g"),h=new RegExp("([^]*?)"+u(n.tags[0])+"(-|_)?\\s*("+s+")?\\s*","g"),p=0,m=!1;function f(e,o){var s,u={f:[]},f=0,g="c";function v(e){var o=t.slice(p,e),s=o.trim();if("f"===g)"safe"===s?u.raw=!0:n.async&&a.test(s)?(s=s.replace(a,""),u.f.push([s,"",!0])):u.f.push([s,""]);else if("fp"===g)u.f[u.f.length-1][1]+=s;else if("err"===g){if(s){var r=o.search(/\S/);i("invalid syntax",t,p+r)}}else u[g]=s;p=e+1}for("h"===o||"b"===o||"c"===o?g="n":"r"===o&&(u.raw=!0,o="i"),r.lastIndex=p;null!==(s=r.exec(t));){var _=s[1],y=s[2],b=s[3],$=s[4],w=s[5],x=s.index;if(_)"("===_?(0===f&&("n"===g?(v(x),g="p"):"f"===g&&(v(x),g="fp")),f++):")"===_?0===--f&&"c"!==g&&(v(x),g="err"):0===f&&"|"===_?(v(x),g="f"):"=>"===_&&(v(x),p+=1,g="res");else if(y)if("/*"===y){var A=t.indexOf("*/",r.lastIndex);-1===A&&i("unclosed comment",t,s.index),r.lastIndex=A+2}else"'"===y?(c.lastIndex=s.index,c.exec(t)?r.lastIndex=c.lastIndex:i("unclosed string",t,s.index)):'"'===y?(d.lastIndex=s.index,d.exec(t)?r.lastIndex=d.lastIndex:i("unclosed string",t,s.index)):"`"===y&&(l.lastIndex=s.index,l.exec(t)?r.lastIndex=l.lastIndex:i("unclosed string",t,s.index));else if(b)return v(x),p=x+s[0].length,h.lastIndex=p,m=w,$&&"h"===o&&(o="s"),u.t=o,u}return i("unclosed tag",t,e),u}var g=function s(r,l){r.b=[],r.d=[];var c,d=!1,u=[];function g(t,e){t&&(t=function(t,e,i,n){var o,s;return"string"==typeof e.autoTrim?o=s=e.autoTrim:Array.isArray(e.autoTrim)&&(o=e.autoTrim[1],s=e.autoTrim[0]),(i||!1===i)&&(o=i),(n||!1===n)&&(s=n),"slurp"===o&&"slurp"===s?t.trim():("_"===o||"slurp"===o?t=String.prototype.trimLeft?t.trimLeft():t.replace(/^[\s\uFEFF\xA0]+/,""):"-"!==o&&"nl"!==o||(t=t.replace(/^(?:\n|\r|\r\n)/,"")),"_"===s||"slurp"===s?t=String.prototype.trimRight?t.trimRight():t.replace(/[\s\uFEFF\xA0]+$/,""):"-"!==s&&"nl"!==s||(t=t.replace(/(?:\n|\r|\r\n)$/,"")),t)}(t,n,m,e))&&(t=t.replace(/\\|'/g,"\\$&").replace(/\r\n|\n|\r/g,"\\n"),u.push(t))}for(;null!==(c=h.exec(t));){var v,_=c[1],y=c[2],b=c[3]||"";for(var $ in o)if(o[$]===b){v=$;break}g(_,y),p=c.index+c[0].length,v||i("unrecognized tag type: "+b,t,p);var w=f(c.index,v),x=w.t;if("h"===x){var A=w.n||"";n.async&&a.test(A)&&(w.a=!0,w.n=A.replace(a,"")),w=s(w),u.push(w)}else if("c"===x){if(r.n===w.n)return d?(d.d=u,r.b.push(d)):r.d=u,r;i("Helper start and end don't match",t,c.index+c[0].length)}else if("b"===x){d?(d.d=u,r.b.push(d)):r.d=u;var S=w.n||"";n.async&&a.test(S)&&(w.a=!0,w.n=S.replace(a,"")),d=w,u=[]}else if("s"===x){var E=w.n||"";n.async&&a.test(E)&&(w.a=!0,w.n=E.replace(a,"")),u.push(w)}else u.push(w)}if(!l)throw e('unclosed helper "'+r.n+'"');return g(t.slice(p,t.length),!1),r.d=u,r}({f:[]},!0);if(n.plugins)for(var v=0;v<n.plugins.length;v++){var _=n.plugins[v];_.processAST&&(g.d=_.processAST(g.d,n))}return g.d}function m(t,e){var i=p(t,e),n="var tR='';"+(e.useWith?"with("+e.varName+"||{}){":"")+y(i,e)+"if(cb){cb(null,tR)} return tR"+(e.useWith?"}":"");if(e.plugins)for(var o=0;o<e.plugins.length;o++){var s=e.plugins[o];s.processFnString&&(n=s.processFnString(n,e))}return n}function f(t,e){for(var i=0;i<e.length;i++){var n=e[i][0],o=e[i][1];t=(e[i][2]?"await ":"")+"c.l('F','"+n+"')("+t,o&&(t+=","+o),t+=")"}return t}function g(t,e,i,n,o,s){var r="{exec:"+(o?"async ":"")+_(i,e,t)+",params:["+n+"]";return s&&(r+=",name:'"+s+"'"),o&&(r+=",async:true"),r+"}"}function v(t,e){for(var i="[",n=0;n<t.length;n++){var o=t[n];i+=g(e,o.res||"",o.d,o.p||"",o.a,o.n),n<t.length&&(i+=",")}return i+"]"}function _(t,e,i){return"function("+e+"){var tR='';"+y(t,i)+"return tR}"}function y(t,e){for(var i=0,n=t.length,o="";i<n;i++){var s=t[i];if("string"==typeof s)o+="tR+='"+s+"';";else{var r=s.t,a=s.c||"",l=s.f,c=s.n||"",d=s.p||"",h=s.res||"",u=s.b,p=!!s.a;if("i"===r){e.defaultFilter&&(a="c.l('F','"+e.defaultFilter+"')("+a+")");var m=f(a,l);!s.raw&&e.autoEscape&&(m="c.l('F','e')("+m+")"),o+="tR+="+m+";"}else if("h"===r)if(e.storage.nativeHelpers.get(c))o+=e.storage.nativeHelpers.get(c)(s,e);else{var _=(p?"await ":"")+"c.l('H','"+c+"')("+g(e,h,s.d,d,p);_+=u?","+v(u,e):",[]",o+="tR+="+f(_+=",c)",l)+";"}else"s"===r?o+="tR+="+f((p?"await ":"")+"c.l('H','"+c+"')({params:["+d+"]},[],c)",l)+";":"e"===r&&(o+=a+"\n")}}return o}var b=function(){function t(t){this.cache=t}return t.prototype.define=function(t,e){this.cache[t]=e},t.prototype.get=function(t){return this.cache[t]},t.prototype.remove=function(t){delete this.cache[t]},t.prototype.reset=function(){this.cache={}},t.prototype.load=function(t){r(this.cache,t,!0)},t}();function $(t,i,n,o){if(i&&i.length>0)throw e((o?"Native":"")+"Helper '"+t+"' doesn't accept blocks");if(n&&n.length>0)throw e((o?"Native":"")+"Helper '"+t+"' doesn't accept filters")}var w={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};function x(t){return w[t]}var A=new b({}),S=new b({each:function(t,e){var i="",n=t.params[0];if($("each",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,o,s){n(e[i],i).then(function(r){o+=r,i===e.length-1?s(o):t(e,i+1,n,o,s)})}(n,0,t.exec,i,e)});for(var o=0;o<n.length;o++)i+=t.exec(n[o],o);return i},foreach:function(t,e){var i=t.params[0];if($("foreach",e,!1),t.async)return new Promise(function(e){!function t(e,i,n,o,s,r){o(i[n],e[i[n]]).then(function(a){s+=a,n===i.length-1?r(s):t(e,i,n+1,o,s,r)})}(i,Object.keys(i),0,t.exec,"",e)});var n="";for(var o in i)s(i,o)&&(n+=t.exec(o,i[o]));return n},include:function(t,i,n){$("include",i,!1);var o=n.storage.templates.get(t.params[0]);if(!o)throw e('Could not fetch template "'+t.params[0]+'"');return o(t.params[1],n)},extends:function(t,i,n){var o=t.params[1]||{};o.content=t.exec();for(var s=0;s<i.length;s++){var r=i[s];o[r.name]=r.exec()}var a=n.storage.templates.get(t.params[0]);if(!a)throw e('Could not fetch template "'+t.params[0]+'"');return a(o,n)},useScope:function(t,e){return $("useScope",e,!1),t.exec(t.params[0])}}),E=new b({if:function(t,e){$("if",!1,t.f,!0);var i="if("+t.p+"){"+y(t.d,e)+"}";if(t.b)for(var n=0;n<t.b.length;n++){var o=t.b[n];"else"===o.n?i+="else{"+y(o.d,e)+"}":"elif"===o.n&&(i+="else if("+o.p+"){"+y(o.d,e)+"}")}return i},try:function(t,i){if($("try",!1,t.f,!0),!t.b||1!==t.b.length||"catch"!==t.b[0].n)throw e("native helper 'try' only accepts 1 block, 'catch'");var n="try{"+y(t.d,i)+"}",o=t.b[0];return n+"catch"+(o.res?"("+o.res+")":"")+"{"+y(o.d,i)+"}"},block:function(t,e){return $("block",t.b,t.f,!0),"if(!"+e.varName+"["+t.p+"]){tR+=("+_(t.d,"",e)+")()}else{tR+="+e.varName+"["+t.p+"]}"}}),C=new b({e:function(t){var e=String(t);return/[&<>"']/.test(e)?e.replace(/[&<>"']/g,x):e}}),T={varName:"it",autoTrim:[!1,"nl"],autoEscape:!0,defaultFilter:!1,tags:["{{","}}"],l:function(t,i){if("H"===t){var n=this.storage.helpers.get(i);if(n)return n;throw e("Can't find helper '"+i+"'")}if("F"===t){var o=this.storage.filters.get(i);if(o)return o;throw e("Can't find filter '"+i+"'")}},async:!1,storage:{helpers:S,nativeHelpers:E,filters:C,templates:A},prefixes:{h:"@",b:"#",i:"",r:"*",c:"/",e:"!"},cache:!1,plugins:[],useWith:!1};function k(t,e){var i={};return r(i,T),e&&r(i,e),t&&r(i,t),i.l.bind(i),i}function z(t,i){var n=k(i||{}),s=Function;if(n.async){if(!o)throw e("This environment doesn't support async/await");s=o}try{return new s(n.varName,"c","cb",m(t,n))}catch(i){throw i instanceof SyntaxError?e("Bad template syntax\n\n"+i.message+"\n"+Array(i.message.length+1).join("=")+"\n"+m(t,n)):i}}function O(t,e){var i;return e.cache&&e.name&&e.storage.templates.get(e.name)?e.storage.templates.get(e.name):(i="function"==typeof t?t:z(t,e),e.cache&&e.name&&e.storage.templates.define(e.name,i),i)}T.l.bind(T),t.compile=z,t.compileScope=y,t.compileScopeIntoFunction=_,t.compileToString=m,t.defaultConfig=T,t.filters=C,t.getConfig=k,t.helpers=S,t.nativeHelpers=E,t.parse=p,t.render=function(t,i,o,s){var r=k(o||{});if(!r.async)return O(t,r)(i,r);if(!s){if("function"==typeof n)return new n(function(e,n){try{e(O(t,r)(i,r))}catch(t){n(t)}});throw e("Please provide a callback function, this env doesn't support Promises")}try{O(t,r)(i,r,s)}catch(t){return s(t)}},t.templates=A,Object.defineProperty(t,"__esModule",{value:!0})}(Ht.exports)),Ht.exports}var Vt=It();const Ut=2;class Dt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class Ft extends Dt{constructor(t){if(super(t),this.it=q,t.type!==Ut)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===q||null==t)return this._t=void 0,this.it=t;if(t===W)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Ft.directiveName="unsafeHTML",Ft.resultType=1;const Lt=(t=>(...e)=>({_$litDirective$:t,values:e}))(Ft),Bt=t=>`<ha-icon icon="${t}"></ha-icon>`;function Wt(t,e){const i=t?.layout?.sensors?.type??"table";return B` <div class="sensors ${[t?.layout?.sensors?.labels??!0?"with-labels":"without-labels","list"===i?"as-list":"as-table"].join(" ")}">${e}</div> `}function qt({hide:t=!1,hass:e,state:i,details:n,openEntityPopover:o}){if(t||void 0===i)return;const{type:s,heading:r,icon:a,unit:l,decimals:c}=n;let d;if("relativetime"===s)d=B`
    ...
    `}else{let t="number"==typeof c?Mt(i,{decimals:c}):i;d=B` <div class="sensor-value">${t}${l?` ${l}`:""}</div> `}if(!1===r)return d;const h=a?B` <ha-icon .icon=${a}></ha-icon> `:B` ${r}: `;return B`
    <div class="sensor-heading">${h}</div>
    ${d}
  `}var Kt;Vt.defaultConfig.autoEscape=!1,Vt.filters.define("icon",Bt),Vt.filters.define("join",(t,e=", ")=>t.join(e)),Vt.filters.define("css",(t,e)=>`<span style="${Object.entries(e).reduce((t,[e,i])=>`${t}${e}:${i};`,"")}">${t}</span>`),Vt.filters.define("debug",t=>{try{return JSON.stringify(t)}catch{return`Not able to read valid JSON object from: ${t}`}}),function(t){t.OFF="off",t.HEAT="heat",t.COOL="cool",t.HEAT_COOL="heat_cool",t.AUTO="auto",t.DRY="dry",t.FAN_ONLY="fan_only"}(Kt||(Kt={}));const Yt=["vane_horizontal","vane_vertical"];function Zt({state:t,entity:e,hass:i,mode:n,modeOptions:o,localize:s,setMode:r}){const{type:a,hide_when_off:l,mode:c="none",list:d,name:h}=n;if(0===d.length||l&&t===Kt.OFF)return null;const u=Yt.includes(a)?a:`${a}_mode`,p={hvac:"Operation",vane_horizontal:"Vane Horizontal",vane_vertical:"Vane Vertical",swing_horizontal:"Swing Horizontal",swing_vertical:"Swing Vertical"},m="hvac"===a?"operation":`${a}_mode`;let f=h||s(`ui.card.climate.${m}`);if(f===`ui.card.climate.${m}`){const t=`state_attributes.climate.${"hvac"===a?"hvac":a}_mode`;f=s(t),f===t&&(f=p[a]??"Mode")}const g=o?.headings??!1;return B`
  ...
  `}const Gt={auto:"mdi:radiator",cooling:"mdi:snowflake",fan:"mdi:fan",heating:"mdi:radiator",idle:"mdi:radiator-disabled",off:"mdi:radiator-off"},Jt={auto:"mdi:fan-auto",cool:"hass:snowflake",dry:"hass:water-percent",fan_only:"hass:fan",heat_cool:"hass:autorenew",heat:"hass:fire",off:"mdi:power",none:"mdi:minus-circle-outline",eco:"mdi:leaf",away:"mdi:home-export-outline",boost:"mdi:rocket-launch",comfort:"mdi:sofa",home:"mdi:home",sleep:"mdi:sleep",activity:"mdi:run",on:"mdi:fan",automatic:"mdi:fan-auto",normal:"mdi:fan",low:"mdi:fan-speed-1",medium:"mdi:fan-speed-2",high:"mdi:fan-speed-3",turbo:"mdi:fan-alert",powerful:"mdi:fan-plus",quiet:"mdi:fan-minus",silent:"mdi:fan-minus",1:"mdi:fan-speed-1",2:"mdi:fan-speed-2",3:"mdi:fan-speed-3",4:"mdi:fan-plus",5:"mdi:fan-alert",vertical:"mdi:arrow-up-down",top:"mdi:arrow-up","top-middle":"mdi:arrow-top-right",middle:"mdi:arrow-collapse-vertical","middle-bottom":"mdi:arrow-bottom-right",bottom:"mdi:arrow-down",upper:"mdi:arrow-up",lower:"mdi:arrow-down",horizontal:"mdi:arrow-left-right",left:"mdi:arrow-left","center-left":"mdi:arrow-top-left",center:"mdi:arrow-collapse-horizontal","center-right":"mdi:arrow-top-right",right:"mdi:arrow-right",both:"mdi:arrow-all",swing:"mdi:arrow-oscillating",wide:"mdi:arrow-expand-horizontal",narrow:"mdi:arrow-collapse-horizontal",mid:"mdi:arrow-collapse-vertical",split:"mdi:arrow-split-vertical"};function Qt(t,e){const i=e.states[t.entity];if(!i)return null;let n="";return n=!0===t?.name?i.attributes.friendly_name:t?.name??"",{entity:i,label:n,icon:t?.icon??!1}}function Xt(t,e){return Array.isArray(t)?t.filter(({entity:t})=>Boolean(e.states?.[t])).map(({entity:t,...i})=>({...i,state:e.states[t],entity:t})):[]}var te;!function(t){t.HVAC="hvac",t.FAN="fan",t.PRESET="preset",t.SWING="swing",t.SWING_HORIZONTAL="swing_horizontal",t.SWING_VERTICAL="swing_vertical",t.VANE_HORIZONTAL="vane_horizontal",t.VANE_VERTICAL="vane_vertical"}(te||(te={}));const ee="hass:chevron-up",ie="hass:chevron-down",ne="mdi:plus",oe="mdi:minus",se={temperature:!1,state:!1};function re(t,e,i={},n=`${t}_modes`){let o=e[n];return"boolean"==typeof o&&(o=["false","true"]),Array.isArray(o)?o.filter(t=>function(t,e){if("object"==typeof e[t])return!1!==e[t].include;return e?.[t]??!0}(t,i)).map(t=>{const e=String(t),n="object"==typeof i[e]?i[e]:{};return{icon:Jt[e]??Jt[e.toLowerCase()],value:e,name:e,...n}}):[]}class ae extends lt{constructor(){super(...arguments),this.modes=[],this._hass={},this.sensors=[],this.showSensors=!0,this.stepSize=.5,this._values={},this._updatingValues=!1,this._hide=se,this._updatingValuesTimeout=null,this._needsRecompute=!0,this._extTempEntity=null,this._holdTimer=null,this._holdFired=!1,this._clickCount=0,this._clickTimer=null,this._debouncedSetTemperature=Nt(t=>{const{domain:e,service:i,data:n={}}=this.service;this._callAction(`${e}.${i}`,{entity_id:this.config.entity,...n,...t})},{wait:500}),this.localize=(t,e="")=>{const i=`${e}${t}`;return this._hass.localize(i)||t},this.toggleEntityChanged=t=>{if(!this.header||!this.header.toggle)return;const e=t.target;this._callAction(e.checked?"homeassistant.turn_on":"homeassistant.turn_off",{entity_id:this.header.toggle.entity?.entity_id})},this.setMode=(t,e)=>{if(t&&e){const i=yt(this.config.entity),n=i.transformModePayloadValue?i.transformModePayloadValue(t,e):e;this._callAction(i.getModeService(t),{entity_id:this.config.entity,[i.getModePayloadKey(t)]:n}),ft(this,"haptic","light")}else ft(this,"haptic","failure")},this.openEntityPopover=(t=null)=>{ft(this,"hass-more-info",{entityId:t||this.config.entity})},this._onActionPointerDown=t=>{0!==t.button&&"mouse"===t.pointerType||(this._holdFired=!1,this._holdTimer&&clearTimeout(this._holdTimer),this._holdTimer=setTimeout(()=>{this._holdFired=!0,this._holdTimer=null,this._dispatchAction("hold")},ae.HOLD_MS))},this._onActionPointerUp=()=>{this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null)},this._onActionClick=t=>{t.preventDefault(),this._holdFired?this._holdFired=!1:(this._clickCount+=1,1===this._clickCount?(this._clickTimer&&clearTimeout(this._clickTimer),this._clickTimer=setTimeout(()=>{this._clickCount=0,this._clickTimer=null,this._dispatchAction("tap")},ae.DOUBLE_TAP_MS)):(this._clickTimer&&clearTimeout(this._clickTimer),this._clickTimer=null,this._clickCount=0,this._dispatchAction("double_tap")))}}static get styles(){return mt}_callAction(t,e){if("function"==typeof this._hass.performAction)this._hass.performAction({action:t,data:e});else{const[i,n]=t.split(".");this._hass.callService(i,n,e)}}static getConfigElement(){return window.document.createElement(`${t}-editor`)}static getStubConfig(t){return{entity:Object.keys(t.states).find(t=>t.startsWith("climate.")||t.startsWith("fan.")||t.startsWith("humidifier."))??""}}setConfig(t){if(!t?.entity)throw new Error("simple-thermostat: entity is required");this.config={decimals:1,...t},this.service=function(t,e=vt){return t||e.getSetpointService()}(this.config.service??!1,yt(this.config.entity)),this._needsRecompute=!0}disconnectedCallback(){super.disconnectedCallback(),this._updatingValuesTimeout&&(clearTimeout(this._updatingValuesTimeout),this._updatingValuesTimeout=null),this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null),this._clickTimer&&(clearTimeout(this._clickTimer),this._clickTimer=null),this._debouncedSetTemperature?.cancel?.()}updated(t){super.updated(t);const e=Array.from(this.renderRoot.querySelectorAll("[with-hass]"));for(const t of Array.from(e))Array.from(t.attributes).forEach(e=>{e.name.startsWith("fwd-")&&(t[e.name.replace("fwd-","")]=e.value)}),t.hass=this._hass}set hass(t){if(!this.config?.entity||!t?.states)return;this._hass=t;const e=t.states[this.config.entity];if(!e)return void(void 0!==this.entity&&(this.entity=void 0));const i=this.config.current_value_entity??this.config.current_temperature_entity,n=i?t.states[i]:null;if(this.entity===e&&this._extTempEntity===n&&!this._needsRecompute)return;this._extTempEntity=n,this._needsRecompute=!1,this.entity=e,this.header=function(t,e,i){if(!1===t)return!1;let n;n="string"==typeof t?.name?t.name:!1!==t?.name&&e.attributes.friendly_name;let o=e.attributes.hvac_action?Gt:Jt;return void 0!==t?.icon&&(o=t.icon),{name:n,icon:o,toggle:t?.toggle?Qt(t.toggle,i):null,faults:Xt(t?.faults,i)}}(!1!==this.config.header&&(this.config.header??{}),e,t);const o=e.attributes,s=yt(this.config.entity);let r=function(t,e,i=vt){return!1===t?{}:t?Object.entries(t).reduce((t,[i,n])=>(n?.hide||(t[i]=e?.[i]),t),{}):i.getSetpoints(e)}(this.config.setpoints,o,s);this._updatingValues&&function(t,e){const i=Object.keys(t);return i.length===Object.keys(e).length&&!i.some(i=>t?.[i]!==e?.[i])}(r,this._values)?(this._updatingValues=!1,this._updatingValuesTimeout&&(clearTimeout(this._updatingValuesTimeout),this._updatingValuesTimeout=null)):this._updatingValues||(this._values=r);const a=s.getDefaultControl(),l=t=>void 0!==o[s.getModeAttribute(t)],c=t=>t.filter(l).map(t=>({type:t,hide_when_off:!1,list:re(t,o,{},s.getModeAttribute(t))}));let d=[];if(!1===this.config.control)d=[];else if(Array.isArray(this.config.control))d=c(this.config.control);else if("object"==typeof this.config.control){const t=Object.entries(this.config.control);d=t.length>0?t.filter(([t])=>l(t)).map(([t,e])=>{const{_name:i,_hide_when_off:n,...r}=e;return{type:t,hide_when_off:n,name:i,list:re(t,o,r,s.getModeAttribute(t))}}):c(a)}else d=c(a);if(this.modes=d.map(t=>{const i=t.list??[];if(t.type===te.HVAC){const n=Object.values(Kt),o=[],s=[];return i.forEach(t=>{const e=n.indexOf(t.value);e>=0?o[e]=t:s.push(t)}),{...t,list:[...o.filter(Boolean),...s],mode:e.state}}const n=o[s.getModePayloadKey(t.type)];return{...t,mode:null!=n?String(n):"none"}}),this.config.step_size)this.stepSize=+this.config.step_size;else{const t=s.getRange(o).step;null!=t&&(this.stepSize=+t)}if(this._hide={...se,...this.config.hide},!1===this.config.sensors)this.showSensors=!1;else if(3===this.config.version){this.sensors=[];const i=this.config.sensors??[],n=this.config.entity,o=i.map((t,i)=>{const o=t?.entity??n;let s=e;return t?.entity&&(s=this._hass.states?.[t.entity]),{id:t?.id??String(i),label:t?.label,template:t?.template??"",show:!1!==t?.show,entityId:o,context:s}}),r=o.map(t=>t.id),a=[];if(r.includes("state")||a.push({id:"state",label:"{{ui.operation}}",template:"{{state.text}}",entityId:n,context:e,show:!0}),!r.includes("temperature")){const i=this.config.current_value_entity??this.config.current_temperature_entity??n,o=i!==n&&t.states[i];a.push({id:"temperature",label:"{{ui.currently}}",template:o?"{{state.raw|formatNumber}}":s.getCurrentValueTemplate(),entityId:i,context:o?t.states[i]:e,show:!0})}this.sensors=[...a,...o]}else this.config.sensors&&(this.sensors=this.config.sensors.map(({name:e,entity:i,attribute:n,unit:s,...r})=>{let a;const l=[e];return i?(a=t.states[i],l.push(a?.attributes?.friendly_name),n&&(a=a?.attributes?.[n])):n&&n in o&&(a=o[n],l.push(n)),l.push(i),{...r,name:l.find(t=>!!t),state:a,entity:i,unit:s}}))}render(){const{_hide:t,_values:e,_updatingValues:i,config:n,entity:o}=this,s=[];if(this.stepSize<1&&0===this.config.decimals&&s.push(B`
      ...
      `:B`<ha-card class="loading"></ha-card>`;const{attributes:{hvac_action:r}}=o,a=yt(this.config.entity),{min:l,max:c}=a.getRange(o.attributes),d=this.getUnit(),h=this.config?.layout?.step??"row",u="row"===h,p=["unavailable","unknown"].includes(o.state),m=t=>"string"==typeof t?t.replace(/[^a-z0-9_-]/gi,""):"",f=[!this.header&&"no-header",m(r),p&&m(o.state)].filter(t=>!!t);let g;return 3===this.config.version?(g=this.sensors.filter(t=>!1!==t.show).map(t=>function({context:t,entityId:e,template:i="{{state.text}}",label:n,hass:o,variables:s={},config:r,localize:a,openEntityPopover:l}){if(!t)return null;const{state:c,attributes:d}=t,[h]=e.split("."),u=["climate","fan","humidifier"].includes(h)?`ui.card.${h}.`:"ui.card.climate.",p=Object.fromEntries(["currently","operation","fan_mode","swing_mode","preset_mode","humidity"].map(t=>[t,o.localize?.(`${u}${t}`)??t])),m={...d,state:{raw:c,text:a(c,`component.${h}.state._.`)},ui:p,v:s};Vt.filters.define("formatNumber",(t,e={decimals:r.decimals})=>String(Mt(t,e))),Vt.filters.define("relativetime",t=>`<ha-relative-time fwd-datetime=${t} with-hass></ha-relative-time>`),Vt.filters.define("translate",(t,e="")=>a(t,e||"climate"!==h&&"humidifier"!==h?e:`state_attributes.${h}.${t}`));const f=t=>{try{return Vt.render(t,m,{useWith:!0})}catch{return`[template error: ${t}]`}},g=f(i);if(!1===n||!1===r?.layout?.sensors?.labels)return B`<div class="sensor-value">${Lt(g)}</div>`;const v=n||"{{friendly_name}}",_=v.match(/^(mdi|hass):.*/)?Bt(v):f(v);return B`
    <div class="sensor-heading">${Lt(_)}</div>
    <div class="sensor-value">${Lt(g)}</div>
  `}({...t,variables:this.config.variables,hass:this._hass,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover})),g=Wt(this.config,g)):g=this.showSensors?function({_hide:t,entity:e,unit:i,hass:n,sensors:o,config:s,localize:r,openEntityPopover:a}){const{attributes:{hvac_action:l}}=e,c=yt(s?.entity),d=c.getCurrentValue(e.attributes),h=s?.current_value_entity??s?.current_temperature_entity,u=h?n.states?.[h]?.state:void 0,p=void 0!==u?u:d,m=s?.layout?.sensors?.labels??!0,f=c.getLocalizationDomain();let g=n.formatEntityState(e);l&&(g=[n.formatEntityAttributeValue(e,"hvac_action",l),` (${g})`].join(""));const v=[qt({hide:t.temperature,state:`${Mt(p,s)}${i||""}`,hass:n,details:{heading:!!m&&(s?.label?.temperature??r(`ui.card.${f}.currently`))}}),qt({hide:t.state,state:g,hass:n,details:{heading:!!m&&(s?.label?.state??r("ui.panel.lovelace.editor.card.generic.state"))}}),...o.map(({name:t,state:e,...i})=>qt({state:e,hass:n,openEntityPopover:a,details:{...i,heading:m&&t}}))].filter(Boolean);return Wt(s,v)}({_hide:t,unit:d,hass:this._hass,entity:o,sensors:this.sensors,config:this.config,localize:this.localize,openEntityPopover:this.openEntityPopover}):"",B`
      <ha-card class="${f.join(" ")}">
        ...
        <section class="body">
          ${g}
          ${!0===n.hide_setpoint?q:Object.entries(e).map(([t,e])=>{const s=["string","number"].includes(typeof e),r="number"==typeof e?e:Number(e),a=!1!==d&&s;return B`
